      ...
      <div className="w-full max-w-[1400px] flex items-center justify-between gap-4">
        ...
        <div className="flex-grow px-16 text-white">
          ...
          <div>
            ...
            <input type="text" placeholder="Adress" className="w-full max-w-md p-4 border-b border-gray-600 focus-within:border-orange-500 transition-colors text-orange-500" />
            </div>
            <div>
             <div className="flex flex-col w-full pt-4">
              <textarea rows={4} className="bg-transparent py-3 pt-4 border-b border-gray-600 focus:outline-none focus:border-orange-500 transition-colors resize-none text-orange-500" placeholder="Content"></textarea>
            </div>  
