      ...
      <div className="w-full max-w-[1400px] flex items-center justify-between gap-4">
        ...
        <div className="flex-grow px-16 text-white">
          ...
          <div className="space-y-6">
            <h3 className="text-[36px] font-light tracking-widest  ">
            ...
            <p className="text-gray-400 text-lg leading-relaxed  pt-4 text-[20px]">
          ...
          <div className="flex gap-24 mt-16">
            <div className="flex flex-col gap-3">
              <h2 className="text-6xl text-orange-500 font-light tracking-tighter">3 +</h2>
              <p className="text-gray-500 uppercase text-xs tracking-[0.3em] leading-tight font-semibold">
                Years of<br/>Experience
              </p>
            </div>
            <div className="flex flex-col gap-3">
              <h2 className="text-6xl text-orange-500 font-light tracking-tighter">10 +</h2>
              <p className="text-gray-500 uppercase text-xs tracking-[0.3em] leading-tight font-semibold">
